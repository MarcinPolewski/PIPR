...
def test_distance_A_not_number():
    with pytest.raises(TypeError):
        distance(14, "dupadupa", (5, -2))


def test_distance_B_not_number():
    with pytest.raises(TypeError):
        distance(14, (-13, -6), "dupadupa")


def test_distance_A_greater_than_N():
    with pytest.raises(ValueError):
        distance(14, (-100, -6), (5, -2))


def test_distance_B_greater_than_N():
    with pytest.raises(ValueError):
        distance(14, (-13, -6), (500, -2))
