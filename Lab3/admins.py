...
def print_admin_name():
    for name in admin_names:
        print(name)


# tak NIE pisać, bo jesteśmy wtedy podatni na zmiany zmiennej globalnej !!!
print_admin_name()


def print_admin_name(admin_list):
    for name in admin_list:
        print(name)


print_admin_name(admin_names)
# tak lepiej, bo bierzemy stan zmiennej globalnej z momentu wywołania printu
...
def is_in_admin_sites(name):
    return name in admin_sites


print(is_in_admin_sites("Ervin Howell"))
print(is_in_admin_sites("Johna Smitha"))
...
def get_geo_location(list_full):
    geo_list = []
    for admin in list_full:
        geo_list.append(admin["address"]["geo"]["lng"])
    return geo_list


print(get_geo_location(admins_full))
